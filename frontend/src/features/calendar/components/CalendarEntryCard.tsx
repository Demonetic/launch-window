...
import {
    toClassName,
    viewingLabels,
} from '../../launches/model/launchPresentation'
import { CalendarInviteForm } from './CalendarInviteForm'
import { CalendarParticipantAvatars } from './CalendarParticipantAvatars'
import type { CalendarEntry } from '../model/types'
...
export function CalendarEntryCard({
    ...
    const { launch, participants } = entry
    ...
    return (
        ...
        >
            ...
            <div className="calendar-entry-card">
                <Link
                    className="calendar-entry-main"
                    to={`/launches/${launch.id}`}
                    onClick={rememberCalendarPosition}
                    state={{
                ...
                <footer className="calendar-entry-footer">
                    <CalendarParticipantAvatars
